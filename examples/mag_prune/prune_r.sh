...
do
    ...
    do
        ...
        --name resnet18_${DATASET_ABBR}_${mode}_prune${RATIO}_lr${lr}_iter${iter}_${id} \
        --batch_size 64 \
        --feat_lmda ${lmda} \
        --lr ${lr} \
        --network resnet18 \
        ...
        # WORKDIR=results/prune/resnet18_${DATASET_ABBR}_${mode}_prune${RATIO}_lr${lr}_iter${iter}_${id}
