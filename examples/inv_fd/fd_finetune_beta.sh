...
for i in 0 
do
    for betalmda in 0 5e-2 5e-3
    # for lmda in 2e-1 3e-1
    do
        DATASET=${DATASETS[i]}
        ...
        NAME=resnet18_${DATASET_ABBR}_lr${lr}_iter${iter}_feat${lmda}_sp${splmda}_beta${betalmda}_wd${wd}_mmt${mmt}_${id}
