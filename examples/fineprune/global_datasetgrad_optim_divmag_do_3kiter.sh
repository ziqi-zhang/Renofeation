...
lr${lr}_iter${iter}_feat${lmda}_wd${wd}_mmt${mmt}_${id}
            DIR=results/fineprune/global_datasetgrad_div_mag/correct_3kiter/do_conv1/lowbound${low_bound}
            ...
            --momentum ${mmt} \
            --output_dir ${DIR} \
            --method global_datasetgrad_div_mag_3kiter \
