...
lr${lr}_iter${iter}_feat${lmda}_wd${wd}_mmt${mmt}_${id}
            # DIR=results/datasetgrad/global_datasetgrad_divmag_avg/trial_mmt0.9/lowbound${low_bound}
            DIR=results/datasetgrad/global_datasetgrad_divmag_avg/lrschedule/trial${trial_iter}
            ...
            --momentum ${mmt} \
            --output_dir ${DIR} \
            --method global_datasetgrad_divmag_iter_avg \
