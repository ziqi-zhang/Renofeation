...
do
    ...
    DIR=results/train_process/renofeation2
    NAME=resnet18_${DATASET_ABBR}_reinit_constlr_lr${lr}_do1e-1_iter${iter}_feat${lmda}_wd${wd}_mmt${mmt}_${id}
    CKPT_DIR=results/train_process/renofeation1/resnet18_${DATASET_ABBR}_reinit_lr1e-2_iter90000_feat5e0_wd5e-3_mmt0.9_0
